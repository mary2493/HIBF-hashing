...
{
    app_test_result const result = execute_app("HIBF-hashing", "-v");
...
{
    app_test_result const result = execute_app("HIBF-hashing", data("in.fastq"));
...
{
    app_test_result const result = execute_app("HIBF-hashing", data("in.fastq"), "-v");
...
{
    app_test_result const result = execute_app("HIBF-hashing", data("in.fastq"), "-o", "out.fasta");
...
{
    app_test_result const result = execute_app("HIBF-hashing", data("in.fastq"), "-o", "");
...
{
    app_test_result const result = execute_app("HIBF-hashing", data("in.fastq"), "-o", "does_not_exist/out.fasta");
